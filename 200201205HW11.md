# CPU 
## code 
* [CPU.hdl](https://github.com/cycyucheng1010/co109a/blob/master/05/CPU.hdl)
* [CPU.out](https://github.com/cycyucheng1010/co109a/blob/master/05/CPU.out)
* [CPU-external.out](https://github.com/cycyucheng1010/co109a/blob/master/05/CPU-external.out)
```
...
```
![CPU.jpg](https://github.com/cycyucheng1010/co109a/blob/master/05/CPU.jpg)
## 補充
* 圖片參考計算機系統要素94頁的圖5.9。
* Aregister-c ----->利用instruction[5],instruction[15]做出
* Dregister-c------>利用instruction[15],instruction[4]做出
* PC-c------------->利用zr&&ng以及instruction[0],instruction[1],instruction[2]分別做出JGT,JEQ,JGE,JLT,Pass等指令最後再做出PC之load
